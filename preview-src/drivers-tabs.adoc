...
== Tabbed example where the tabbed section has a label

[.tabbed-example.label--new-2025.12]
====
[.include-with-macos]
======
Tab for macOS
...
== Tabbed example where tabs each have a label assigned
...
Tab for macOS
======
[.include-with-linux.label--linux]
======
Tab for Linux
======
[.include-with-windows.label--windows]
======
Tab for Windows
======
[.include-with-whatever.label--whatever]
======
Tab for whatever
======
====
...
== Tabbed example where one tab has a label assigned
